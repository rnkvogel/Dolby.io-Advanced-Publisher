...
Chrome may lock the default camera to just 640x480. A helper and alert are added if the camera resolution is pinned to 640x480.
...
# Publishing Stats 
Helps publishers identify issues with the publishing stream such as packet loss.
