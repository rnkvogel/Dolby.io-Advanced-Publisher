...
document.addEventListener("DOMContentLoaded", async (event) => {
    ...
    // Next Dual Camera mode. Best to combine with NDI Tools or OBS Virtual Cam
    async function startDualCamera() {
        ...
        try {
            ...
            // Determine PiP (user-chosen or auto-pick). Not sure if only one source is available behavior.
